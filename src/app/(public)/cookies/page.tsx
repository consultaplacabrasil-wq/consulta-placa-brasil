...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: page?.seoCanonical || "https://consultaplacabrasil.com.br/cookies" },
    robots: page?.seoRobots || "index, follow",
    openGraph: {
      title: page?.ogTitle || "Política de Cookies",
      description: page?.ogDescription || undefined,
      images: page?.ogImage ? [page.ogImage] : undefined,
      url: page?.ogUrl || "https://consultaplacabrasil.com.br/cookies",
    },
  };
}
...
export default async function CookiesPage() {
  ...
  const defaultContent = `
    ...
    <h3>Contato</h3>
    <p>Para dúvidas sobre nossa política de cookies, entre em contato pelo e-mail contato@consultaplacabrasil.com.br.</p>
  `;
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: "https://consultaplacabrasil.com.br/cookies",
          }),
        }}
      />
    </div>
