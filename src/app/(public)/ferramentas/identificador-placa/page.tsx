      ...
      <section className="bg-[#0F172A] text-white py-10">
        <div className="container mx-auto px-4 max-w-4xl">
          <nav aria-label="Breadcrumb" className="flex items-center text-sm text-gray-500 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-gray-300">Identificador de Placa</span>
          </nav>
          <h1 className="text-3xl md:text-4xl font-bold mb-3">
            Identificador de Placa Veicular
          </h1>
          <p className="text-gray-400 max-w-2xl mb-4">
            Digite a placa do veículo e descubra se ela segue o padrão Mercosul ou o formato antigo, valide o formato e veja a representação visual.
          </p>
