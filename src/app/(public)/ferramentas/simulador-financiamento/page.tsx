      ...
      <section className="bg-white px-4 py-16">
        <div className="container mx-auto max-w-4xl prose prose-gray space-y-4">
          ...
          <p className="text-[#475569] leading-relaxed">
            ...
            <Link href="/" className="text-[#C73A1E] hover:underline font-medium">buscar placa</Link> do
          ...
          <p className="text-[#475569] leading-relaxed">
            ...
            <Link href="/ferramentas/calculadora-depreciacao" className="text-[#C73A1E] hover:underline font-medium">calculadora de depreciação</Link> para
