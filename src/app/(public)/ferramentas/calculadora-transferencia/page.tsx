      ...
      <div className="bg-white border-b border-gray-100">
        <div className="container mx-auto px-4 max-w-6xl py-3">
          <nav aria-label="Breadcrumb" className="flex items-center text-sm text-[#64748B]">
            ...
            <ChevronRight className="w-4 h-4 mx-2 flex-shrink-0" />
            <span className="text-[#0F172A] font-medium">Calculadora de Transferência</span>
          </nav>
        </div>
      </div>
      ...
      <section className="bg-[#0F172A] text-white py-12 md:py-16">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Descubra quanto custa transferir um veículo no Brasil. Informe os estados de origem
            e destino, o valor do veículo e o tipo de transferência para obter uma estimativa
